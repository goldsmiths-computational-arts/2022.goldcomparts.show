import { c as create_ssr_component, a as subscribe, b as add_attribute, v as validate_component } from "../../_app/immutable/chunks/index-ec3180ae.js";
import { p as page } from "../../_app/immutable/chunks/Header.svelte_svelte_type_style_lang-e640088b.js";
  ...
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-t2wq17"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.url.pathname === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Home</a></li>
			<li class="${["svelte-t2wq17", $page.url.pathname === "/art" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/art"}" class="${"svelte-t2wq17"}">Art</a></li>
			<li class="${["svelte-t2wq17", $page.url.pathname === "/schedule" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/schedule"}" class="${"svelte-t2wq17"}">Schedule</a></li>
			<li class="${["svelte-t2wq17", $page.url.pathname === "/floor-plan" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/floor-plan"}" class="${"svelte-t2wq17"}">Floor Plan</a></li>
			<li class="${["svelte-t2wq17", $page.url.pathname === "/location" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/location"}" class="${"svelte-t2wq17"}">Location</a></li>
