import { c as create_ssr_component, a as subscribe, b as add_attribute, e as escape, v as validate_component } from "../../internal/immutable/chunks/index-0088c08a.js";
import { p as page } from "../../internal/immutable/chunks/Header.svelte_svelte_type_style_lang-e21b4be3.js";
...
const css = {
  code: "main.svelte-1bnrw28{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:1024px;margin:0 auto;box-sizing:border-box}footer.svelte-1bnrw28{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:40px}",
  map: null
};
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-1bnrw28"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
	<main class="${"svelte-1bnrw28"}">${slots.default ? slots.default({}) : ``}</main>
    <footer class="${"svelte-1bnrw28"}">Comparts show </footer>
