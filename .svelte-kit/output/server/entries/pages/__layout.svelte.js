...
const css$1 = {
  code: "#logo.svelte-1he4tp0.svelte-1he4tp0{float:left}#logo.svelte-1he4tp0 a.svelte-1he4tp0{padding:7px 4px 4px 4px;display:flex;align-items:center;justify-content:left;width:100%;height:100%;text-decoration:none;font-family:NeutrafaceSlabDisplay;font-weight:300;font-size:30px}nav.svelte-1he4tp0.svelte-1he4tp0{background:var(--white);opacity:0.9;width:100%}nav.svelte-1he4tp0 .menu-minimized.svelte-1he4tp0{position:absolute}nav.svelte-1he4tp0 .menu-expanded.svelte-1he4tp0{position:relative}ul.svelte-1he4tp0.svelte-1he4tp0{margin:0;padding:0em;height:3em;overflow:hidden;list-style:none;background-size:contain}ul.svelte-1he4tp0 .menu-expanded.svelte-1he4tp0{display:flex;flex-direction:column;justify-content:space-around;align-items:center}#overlay.svelte-1he4tp0.svelte-1he4tp0{margin-top:3em;padding-top:8em;padding-bottom:15em;position:absolute;width:100%;height:35%;max-height:600px;z-index:1;background-color:white}li.svelte-1he4tp0.svelte-1he4tp0{position:relative;float:right}#hamburger-menu.svelte-1he4tp0.svelte-1he4tp0{position:relative;height:36px;object-fit:contain;float:right}li.active.svelte-1he4tp0.svelte-1he4tp0::before{--size:6px;content:'';width:0;height:0}li.svelte-1he4tp0 a.svelte-1he4tp0{display:block;color:white;text-align:center;padding:0px;text-decoration:none;font-size:30px}li.active.svelte-1he4tp0.svelte-1he4tp0{text-decoration:underline overline}li.svelte-1he4tp0 a.svelte-1he4tp0:hover:not(.active){background-color:var(--matrix_green)}nav.svelte-1he4tp0 a.svelte-1he4tp0{display:flex;height:100%;align-items:center;padding:0 1em;color:var(--heading-color);font-weight:700;font-size:24px;text-transform:uppercase;letter-spacing:0.1em;transition:color 0.2s linear}@media(min-width: 720px){nav.svelte-1he4tp0 a.svelte-1he4tp0{font-size:16px}ul.svelte-1he4tp0.svelte-1he4tp0{padding:1em}#logo.svelte-1he4tp0 a.svelte-1he4tp0{padding:0px}}",
  map: null
};
...
<header class="${"svelte-1he4tp0"}"><nav aria-label="${"main navigation"}" class="${escape(null_to_empty(""), true) + " svelte-1he4tp0"}"><div class="${"container"}"><ul class="${"svelte-1he4tp0"}"><li id="${"logo"}" class="${["svelte-1he4tp0", $page.url.pathname === "/home" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${escape(base, true) + "/"}" class="${"svelte-1he4tp0"}">(SUB)SYSTEMS</a></li> 
